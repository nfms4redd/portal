define([ "message-bus", "layout", "jquery", "toolbar" ], function(bus, layout, $) {
	bus.send("css-load", "modules/new-layer.css");
	...
	btnNewLayer.click(function() {
		...
		txtLayerName.addClass("text ui-widget-content ui-corner-all");
		...
		txtURL.addClass("text ui-widget-content ui-corner-all");
